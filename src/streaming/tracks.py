...
class SingleRelease(Song):
    ...
    def __init__(self,track_id: str, title:str, duration_seconds:int, artist, genre:str, release_date: date):
        super().__init__(track_id, title, duration_seconds, genre, artist)
        self.release_date = release_date

class AlbumTrack(Song):

    def __init__(self, track_id:str, title:str, duration_seconds:int, genre: str, artist:Artist, album= None, track_number:int =0):
        super().__init__(track_id, title, duration_seconds, genre, artist)
